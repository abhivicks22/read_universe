...
export default function HighlightPopup({ onTranslate }: { onTranslate?: (text: string, x: number, y: number) => void } = {}) {
    const {
        highlightSelection,
        hideHighlightPopup,
        fileHash,
    ...
    return (
        ...
        >
            ...
            {onTranslate && (
                <button
                    onClick={() => {
                        onTranslate(highlightSelection.text, highlightSelection.x, highlightSelection.y);
                        hideHighlightPopup();
                    }}
